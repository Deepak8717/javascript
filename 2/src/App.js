...
const App = () => {
  ...
  form.addEventListener("submit", (e) => {
    ...
    getList(person)
      ...
      .catch((error) => {
        ...
        setDOM(
          heading,
          `<h1>Sorry, Looks like we could not talk to YouTube. <strong>Worry not, we got a video below for you to keep the party going!</strong></h1><p><code>${error}</code>.</p>`
        );
        setDOM(
          main,
          `<iframe src="https://www.youtube.com/embed/_z-1fTlSDF0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe`
        );
  ...
  setDOM(
    main,
    `<p>Landed at a party and everyone looking at you to get the music going on, we got you covered. Enter the age of your buddy and your preferred language, and we will give you tailored list to play and get you out of trouble!</p><ol><li>Select your language.</li><li>Select your age.</li><li>Filter videos by your preference.</li><li>How many videos do you need?</li></ol>`
  );
  return <></>;
};
