  ...
  if (quote === undefined || quote.length === 0)
    return (
      <div className='jumbotron'>
        <h1 className='display-1'>No quotes asked for yet!</h1>
      </div>
    );
  return (
    <div className='jumbotron'>
...
const App = () => {
  ...
  const getQuote = (flag) => {
    axios
      .get(
        `https://cors-unlimited.herokuapp.com/http://numbersapi.com/${flag}`,
        { crossDomain: true }
      )
      .then((response) => {
        ...
        <div className='row'>
          <div className='d-flex justify-content-center align-content-center align-items-center flex-column col feature'>
            <div className='d-flex justify-content-center align-content-center align-items-center flex-column'>
              <small>
                <label htmlFor='custom-filter' className='d-block'>
                  Enter custom filters like 5, 5/math, 5/date, 5/year, date in
                  format mm/dd like 7/3 to get a custom fact:
                </label>
              </small>
              ...
              <div className='btn-group'>
                ...
                <Button
                  handleClick={handleRandomByYear}
                  text='Random by Year'
                />
                <Button
                  handleClick={handleRandomByMath}
                  text='Random by Math'
                />
                <Button
                  handleClick={handleRandomByDate}
                  text='Random by Date'
                />
              </div>
              <p className='small m-2'>
                Get interesting quotes about Numbers either randomly, based on
                year, math or date.
              </p>
            </div>
            <div className='p-3'>
