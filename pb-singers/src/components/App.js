              ...
              <div className="placeholder">
                <p>
                  {this.state.yourSinger === "" && (
                    <span>
                      Please select a singer you would like to watch videos of
                      today? We will bring you Top 50 YouTube hits of your
                      favorite singer. Get ready for some chill time!
                    </span>
                  )}
                  {this.state.yourSinger !== "" && (
                    <span>
                      Your selected artist is&nbsp;
                      <strong>{this.state.yourSinger}</strong>.
                    </span>
                  )}
                </p>
              </div>
