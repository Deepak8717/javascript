const app = () => {
  ...
  const getFeed = async (cat, subcat) => {
    const url = !subcat
      ? `https://cors-unlimited.herokuapp.com/https://www.insidetoronto.com/rss/article?category=${cat}`
      : `https://cors-unlimited.herokuapp.com/https://www.insidetoronto.com/rss/article?category=${cat}&subcategory=${subcat}`;
    try {
