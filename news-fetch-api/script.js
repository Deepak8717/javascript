...
let createNews = (element) => {
  ...
  cardImg.src =
    typeof cardImgUrl !== 'object'
      ? cardImgUrl
      : 'https://media3.giphy.com/media/3o7qDQtKMMgDktFXu8/giphy.gif?cid=790b76115c9e3f3f6453626d73e2831b';
  ...
  cardDate.insertAdjacentHTML(
    'afterbegin',
    "<span class='fa fa-clock'></span>"
  );
  cardSource.insertAdjacentHTML(
    'afterbegin',
...
let getNews = async (country) => {
  let KEY = '63f86003bea64ef3bae5fca878aeb719';
